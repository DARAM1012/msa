  ...
  return (
    ...
    >
      ...
      <View style={{ marginTop: 10, marginHorizontal: 10, width: "70%" }}>
        <View>
          <Text style={{fontFamily:"NotoSansBlack", color: "#2c2c2c" }}>EMAIL:</Text>
          <TextInput
        ...
        <View style={{ marginTop: 10 }}>
          <Text style={{fontFamily:"NotoSansBlack", color: "#2c2c2c" }}>PASSWORD:</Text>
          <TextInput
            secureTextEntry
        ...
        >
          <TouchableOpacity onPress={doSignUp}>
            <Text style={{fontFamily:"NotoSansBlack", textAlign: "center", color: "#2c2c2c" }}>
              SingUp
            </Text>
          </TouchableOpacity>
        </View>
